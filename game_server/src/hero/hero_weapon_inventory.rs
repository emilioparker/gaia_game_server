...
pub const HERO_WEAPON_INVENTORY_ITEM_SIZE: usize = 7;
...
impl WeaponItem 
{
    pub fn to_bytes(&self) -> [u8; HERO_WEAPON_INVENTORY_ITEM_SIZE]
    {
        let mut start = 0;
        let mut buffer = [0u8;HERO_WEAPON_INVENTORY_ITEM_SIZE];
