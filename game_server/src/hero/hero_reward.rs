pub const HERO_REWARD_SIZE: usize = 12;
...
impl HeroReward 
{
    ...
    pub fn to_bytes(&self) -> [u8;HERO_REWARD_SIZE] 
    {
        let mut buffer = [0u8; HERO_REWARD_SIZE];
    ...
    pub fn from_bytes(data: &[u8]) -> Self {
        ...
        HeroReward { player_id, item_id, amount, inventory_hash}
    }
...
mod tests {
    ...
    fn encode_decode_map_entity()
    {
        ...
        let decoded_reward = HeroReward::from_bytes(&encoded);
